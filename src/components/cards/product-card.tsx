...
export function ProductCard({ product }: { product: ProductWithCategory }) {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-xl border bg-card transition-all hover:border-brand-300 hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <Link href={href} className="mt-1">
          <h3 className="line-clamp-2 font-semibold leading-snug hover:text-brand-700">
            {product.title}
          </h3>
        </Link>
